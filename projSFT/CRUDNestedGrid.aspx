        ...
        <div>
            ...
            <asp:GridView ID="GridView1" AllowPaging="True" BackColor="#f1f1f1" 
                ...
                <asp:TemplateField HeaderText="SectionName" >
                    <ItemTemplate><%# Eval("SecName") %></ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txtSectionName" Text='<%# Eval("SecName") %>' runat="server"></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                ...
                <asp:TemplateField HeaderText="AppId" Visible="false" >
                 ...
                 <asp:TemplateField HeaderText="SectionType">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_SectionType" runat="server" Text='<%#Eval("SecType") %>'></asp:Label>  
                    </ItemTemplate>  
                    <EditItemTemplate>  
                        <asp:DropDownList ID="txtSectionType" runat="server" Text='<%#Eval("SecType") %>' AppendDataBoundItems="True">
                ...
                <asp:TemplateField HeaderText="TotalTestcase" >
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtTotalTestCase" Text='<%# Eval("TotalTestCases") %>' runat="server"></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
			    ...
			    <asp:TemplateField HeaderText="ApplicationName">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_ApplicationName" runat="server" Text='<%#Eval("AppName") %>'></asp:Label>  
                    </ItemTemplate>
                    <%--<EditItemTemplate>  
                            ...
                            <td colspan="150">
                                <div id="div<%# Eval("Id") %>" style="display:none;position:relative;left:5px;OVERFLOW: auto;WIDTH:97%" >
                                    <asp:GridView ID="GridView2" AllowPaging="True"  BackColor="White" Width="100%" Font-Size="X-Small"
                                        AutoGenerateColumns="false" Font-Names="Verdana" runat="server" DataKeyNames="SecId" ShowFooter ="true"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTaskID" Text='<%# Eval("Id") %>' Visible="false" runat="server"></asp:Label>
                                                </ItemTemplate>                            
                                            </asp:TemplateField>
