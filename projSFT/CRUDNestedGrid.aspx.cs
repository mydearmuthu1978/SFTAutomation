...
namespace projSFT
{
    public partial class CRUDNestedGrid : System.Web.UI.Page
    {
        ...
        {
            string strQRY = "SELECT Distinct Applicationname from application";
            ...
            ddlApplist.DataTextField = "Applicationname";
            ddlApplist.DataBind();
        }
        ...
        private void ShowData()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("SP_SectionsOfApplication", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Applicationname", ddlApplist.SelectedItem.Value);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        ((DropDownList)GridView1.FooterRow.FindControl("ddlApplicationName")).DataTextField = "Applicationname";
        ...
        {
            string strQRY = "SELECT [Task].[Sec_id],[Task].[TaskId]," +
                                    "[Task].[Taskname],[Task].[Timetaken] FROM [Task]" +
                                    " WHERE [Task].[Sec_Id] = '" + strId + "'" +
                                    "UNION ALL " +
                                    "SELECT '" + strId + "','','','' FROM [Task] WHERE [Task].[Sec_id] = '" + strId + "'" +
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "AddSection")
            {
                    ...
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ApplicationName", strAppName);
                    cmd.Parameters.AddWithValue("@SectionName", strSectionName);
                    cmd.Parameters.AddWithValue("@SectionType", strSectionType);
                    cmd.Parameters.AddWithValue("@TotalTestCase", strTotalTestCase);
                    con.Open();
                    cmd.ExecuteNonQuery();
                    con.Close();
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            try
            {
                ...
                string strSQL = "";
                strSQL = "UPDATE Section set SectionName = '" + strSectionName + "'" +
                         ",SectionType = '" + strSectionType + "'" +
                         ",TotalTestCase = '" + strTotalTestCase + "'" +
                         " WHERE ID = '" + strID + "'";
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["myDbConnection"].ToString());
        ...
        protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {               
                    ...
                    string strSQL = "";
                    strSQL = "INSERT INTO Task (Sec_id, taskname, timetaken) VALUES ('" + strSecID + "','" + strTaskname + "','" +
                            strTimetaken + "')";
                    SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["myDbConnection"].ToString());
                    SqlCommand cmd = new SqlCommand(strSQL, con);
                    con.Open();
        ...
        protected void GridView2_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            string strSQL = "";
                ...
                strSQL = "DELETE from Task WHERE TaskID = " + strTaskID;
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["myDbConnection"].ToString());
                con.Open(); 
                SqlCommand cmd = new SqlCommand(strSQL, con);
                cmd.ExecuteNonQuery();
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                if (((DataRowView)e.Row.DataItem)["Sec_ID"].ToString() == String.Empty) e.Row.Visible = false;
            }
        }
    }
}
