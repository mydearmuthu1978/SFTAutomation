...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SFT_AutomationConnectionString %>" SelectCommand="SELECT [name] FROM [programs]"></asp:SqlDataSource>
